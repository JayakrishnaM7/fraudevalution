...
@Component
public class Evaluate implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private EvaluateRestProcessor restProcessor;
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Evaluate.class.getName());
         }else{
